...
Setting WallPanel as the default Home application will always load this application as your home. Removing this feature is difficult without uninstalling the application. So please do this if you wish to use the application as a "kiosk" type application.
